...
from tron.api.api_pb2_grpc import WalletStub
from tron.api.api_pb2 import EmptyMessage, AccountAddressMessage, BytesMessage
...
# resp = stub.GetNowBlock2(EmptyMessage())
# print(resp)
